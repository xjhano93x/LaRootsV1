			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td><?php echo number_format($precio_producto,2);?></span></td>
					<td ><span class="pull-right">
					<a href="#" class='btn btn-default' title='Manejar Orden' onclick=""><i class="glyphicon glyphicon-file"></i> </a>
					<a href="#" class='btn btn-default' title='Editar mesa' onclick="obtener_datos('<?php echo $id_producto;?>');" data-toggle="modal" data-target="#myModal2"><i class="glyphicon glyphicon-edit"></i></a> 
					<a href="#" class='btn btn-default' title='Borrar mesa' onclick="eliminar('<?php echo $id_producto; ?>')"><i class="glyphicon glyphicon-trash"></i> </a></span></td>
